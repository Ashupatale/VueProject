<template>
    <div class="LogninDiv" >
        <h1 style="backgroundColor:greenyellow;color:white;width:40%;margin:auto;marginBottom:2%;borderRadius:20px">Sign up Page</h1>
            ...
            <form @submit.prevent="LoginForm" class="form">
                ...
                <br/>
                 <label for="lastname" >Create Your Own Password</label>
                <br/>
...
.LogninDiv{
    ...
    .submitBtn:hover{
        color:white;
        background-color:rgb(155, 230, 44);
    }
